...
const rawNotes = [
  {
    ...
    excerpt: '“你能不能别转笔了！好吵！还有抖腿，不要抖了！”隔着墙我都能听到他转笔掉的声音，我疾步冲到他面前，愤怒的对他吼道。',
    content: [
      <h3 className="post-heading">香水是不是你喷的？</h3>,
      <p className="note-content">{`“你能不能别转笔了！好吵！还有抖腿，不要抖了！”隔着墙我都能听到他转笔掉的声音，我疾步冲到他面前，愤怒的对他吼道。`}</p>,
      ...
      <p className="note-content">我见过人吵架闹的脸红脖子粗的，动手动脚的也不在少数，可是像他这般表情、言语还有肢体传达信息如此割裂的我是头一回碰见，我愣住了，也意识到不能再继续逼他了。我扫了下周围，这么大的办公室里，刚被香水呛出去透气的同事随时会回来。我顺着他的眼神往屏幕看了过去，一张宽大的4k显示器上只孤零零的显示着他的简历，鼠标停留在简历最上方一行，他的名字那样醒目。我一时间有些出神，心中不解，难道他过去几小时鼠标连动都没动吗？这样想着，再看他侧脸潮红一丝未退去，我的怒气瞬时消散，心下一软，转身默默离开了他的工位。</p>,
      <p className="note-content">{`回到隔壁的座位上，打开电脑想继续工作一会，却始终无法集中注意力。我心乱如麻，不知道该做些什么才好，开始回想刚发生的这一切。不管${F}表面多强装镇定，他越说没有，那片红越往上爬，从脖子一直烧到耳根。他爱我？但是在办公室里喷满我前两天用过的香水，这是为什么？他不想别人闻到我的味道吗？他平日里的冷静克制去了哪？我实在想不明白为什么要在大庭广众之下做出来这样子不够体面的事情。我一面生气不解，一面强行让自己大脑静下来分析他的行为动机，试图从他荒唐的行为里解读他真实的想法。`}</p>,
      <p className="note-content">{`我要怎么安抚他？第一次面对这样来势汹涌的——爱意？我无所适从，为数不多的恋爱经验里没有记录过这么一出，我要怎么办？我就这样静静的坐在座位上呆看着电脑屏，过了一会，想着他该缓过来了，继续思考怎么安抚他才好。`}</p>,
      <p className="note-content">{`办公桌上有只绿色的笔，是我很多天前从他位置拿来的，我学着他拿笔转了起来。笔转到桌角，我扫了眼桌角，发现了便利贴，顺手用德语写下“yuichliebedichduschlampe”，写完对着仔细看了看，${F}不懂德语，但是在苏黎世念的硕士，怎么着应该学过一丢丢，前段时间还在跟我秀小舌音。喜欢玩侦探类冒险游戏的他肯定会去查这什么意思。收拾完书包起身走到他座位旁，看到他还在盯着屏幕看，暗暗想他interview要开始了吗，往外张望看有没有同事进来，暂时没有。我把纸条翻了个面，轻轻从桌子一角递给他，没等他做反应，我就背起书包，转身离开了办公室，当然没忘扫他的屏幕，仍然停留在他的简历第一行那里。`}</p>,
      <hr />,
